...
## LEDs
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS25 } [get_ports { STARTUP_IO_0_cfgclk }]; #IO_L15P_T2_DQS_13 Sch=led[0]
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS25 } [get_ports { STARTUP_IO_0_cfgmclk }]; #IO_L15N_T2_DQS_13 Sch=led[1]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS25 } [get_ports { STARTUP_IO_0_eos }]; #IO_L17P_T2_13 Sch=led[2]
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS25 } [get_ports { STARTUP_IO_0_preq }]; #IO_L17N_T2_13 Sch=led[3]
...
## Buttons
set_property -dict { PACKAGE_PIN B22 IOSTANDARD LVCMOS12 } [get_ports { reset }]; #IO_L20N_T3_16 Sch=btnc
...
## QSPI
set_property -dict { PACKAGE_PIN T19   IOSTANDARD LVCMOS33 } [get_ports { SPI_ss_io }]; #IO_L6P_T0_FCS_B_14 Sch=qspi_cs
set_property -dict { PACKAGE_PIN P22   IOSTANDARD LVCMOS33 } [get_ports { SPI_io0_io }]; #IO_L1P_T0_D00_MOSI_14 Sch=qspi_dq[0]
set_property -dict { PACKAGE_PIN R22   IOSTANDARD LVCMOS33 } [get_ports { SPI_io1_io }]; #IO_L1N_T0_D01_DIN_14 Sch=qspi_dq[1]
set_property -dict { PACKAGE_PIN P21   IOSTANDARD LVCMOS33 } [get_ports { SPI_io2_io }]; #IO_L2P_T0_D02_14 Sch=qspi_dq[2]
set_property -dict { PACKAGE_PIN R21   IOSTANDARD LVCMOS33 } [get_ports { SPI_io3_io }]; #IO_L2N_T0_D03_14 Sch=qspi_dq[3]
