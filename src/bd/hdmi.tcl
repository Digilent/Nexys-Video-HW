...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net SYS_Rst_1  [get_bd_pins rst_mig_7series_0_100M/bus_struct_reset] \
  ...
  connect_bd_net -net axi_gpio_video_gpio_io_o  [get_bd_pins axi_gpio_video/gpio_io_o] \
  [get_bd_ports hdmi_hpd]
  ...
  [get_bd_pins rst_mig_7series_0_pxl/slowest_sync_clk] \
  [get_bd_pins v_tc_1/clk] \
  [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  connect_bd_net -net dvi2rgb_0_aPixelClkLckd  [get_bd_pins dvi2rgb_0/pLocked] \
  [get_bd_pins rst_mig_7series_0_pxl/dcm_locked] \
  ...
  connect_bd_net -net mig_7series_0_ui_addn_clk_2  [get_bd_pins mig_7series_0/ui_addn_clk_1] \
  ...
  [get_bd_pins rst_mig_7series_0_pxl/ext_reset_in]
  ...
  connect_bd_net -net rst_mig_7series_0_pxl_peripheral_aresetn  [get_bd_pins rst_mig_7series_0_pxl/peripheral_aresetn] \
  [get_bd_pins v_tc_1/resetn]
  connect_bd_net -net rst_mig_7series_0_pxl_peripheral_reset  [get_bd_pins rst_mig_7series_0_pxl/peripheral_reset] \
  [get_bd_pins v_vid_in_axi4s_0/vid_io_in_reset]
  connect_bd_net -net sys_clk_i_1  [get_bd_ports sys_clk_i] \
